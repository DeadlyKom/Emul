...
// user signal
REGISTER_BUS_NAME(USER_SIGNAL + 0, RAS)
REGISTER_BUS_NAME(USER_SIGNAL + 1, CAS)
REGISTER_BUS_NAME(USER_SIGNAL + 2, RD_ROM)
REGISTER_BUS_NAME(USER_SIGNAL + 3, WR_ROM) // debug
