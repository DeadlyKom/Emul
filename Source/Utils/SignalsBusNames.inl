...
#define SIGNAL_MA2		(USER_SIGNAL + 2)
#define SIGNAL_MA3		(USER_SIGNAL + 3)
#define SIGNAL_MA4		(USER_SIGNAL + 4)
#define SIGNAL_MA5		(USER_SIGNAL + 5)
#define SIGNAL_MA6		(USER_SIGNAL + 6)
#define SIGNAL_MA7		(USER_SIGNAL + 7)

#define SIGNAL_MD0		(USER_SIGNAL + 8)
#define SIGNAL_MD1		(USER_SIGNAL + 9)
#define SIGNAL_MD2		(USER_SIGNAL + 10)
#define SIGNAL_MD3		(USER_SIGNAL + 11)
#define SIGNAL_MD4		(USER_SIGNAL + 12)
#define SIGNAL_MD5		(USER_SIGNAL + 13)
#define SIGNAL_MD6		(USER_SIGNAL + 14)
#define SIGNAL_MD7		(USER_SIGNAL + 15)
...
REGISTER_BUS_NAME(SIGNAL_MA1, MA1)
REGISTER_BUS_NAME(SIGNAL_MA2, MA2)
REGISTER_BUS_NAME(SIGNAL_MA3, MA3)
REGISTER_BUS_NAME(SIGNAL_MA4, MA4)
REGISTER_BUS_NAME(SIGNAL_MA5, MA5)
REGISTER_BUS_NAME(SIGNAL_MA6, MA6)
REGISTER_BUS_NAME(SIGNAL_MA7, MA7)

REGISTER_BUS_NAME(SIGNAL_MD0, MD0)
REGISTER_BUS_NAME(SIGNAL_MD1, MD1)
REGISTER_BUS_NAME(SIGNAL_MD2, MD2)
REGISTER_BUS_NAME(SIGNAL_MD3, MD3)
REGISTER_BUS_NAME(SIGNAL_MD4, MD4)
REGISTER_BUS_NAME(SIGNAL_MD5, MD5)
REGISTER_BUS_NAME(SIGNAL_MD6, MD6)
REGISTER_BUS_NAME(SIGNAL_MD7, MD7)

REGISTER_BUS_NAME(USER_SIGNAL + 16, RAS)
REGISTER_BUS_NAME(USER_SIGNAL + 17, CAS)
REGISTER_BUS_NAME(USER_SIGNAL + 18, WE)

REGISTER_BUS_NAME(USER_SIGNAL + 19, RD_ROM)
REGISTER_BUS_NAME(USER_SIGNAL + 20, WR_ROM) // debug
